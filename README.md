...
| **2025.07** | **교비 어학연수 – De La Salle Araneta University** | 필리핀 현지에서 4주간 영어 회화 및 프레젠테이션 수업 참여 |
...
| 연도 | 📄 연구명 | 📝 학술지 | 📂 연구 내용 |
|:--:|:--|:--|:--|
| **2026.05 ~ 2026.08(예정)** | **컨포멀 예측방법에 기반한 강건한 이상 탐지 연구** | `연구 진행 중` | 단변량 시계열 데이터를 대상으로 10개 이상탐지 알고리즘의 성능을 비교하고, 이상 유형별 탐지 특성과 데이터 적합성을 분석하는 연구 |
